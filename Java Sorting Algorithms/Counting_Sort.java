class Counting_Sort {
    ...
    void Counting_Sort(int[] a, int n)// function to perform counting sort
    {
        int[] output = new int[n + 1];
        int max = getMax(a, n);// int max = 42;
        ...
        // array,and place the element in output array
        for (int i = n - 1; i >= 0; i--) {
